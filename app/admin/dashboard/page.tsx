      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-[#0A0F1C] rounded-[2rem] p-8 text-white relative overflow-hidden shadow-xl border border-white/5">
           ...
           <div className="grid grid-cols-2 gap-4 relative z-10">
              <Link href="/admin/notices" className="p-6 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 hover:border-white/20 transition-all group backdrop-blur-sm">
              ...
              <Link href="/admin/faculty" className="p-6 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 hover:border-white/20 transition-all group backdrop-blur-sm">
              ...
              <Link href="/" target="_blank" className="p-6 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 hover:border-white/20 transition-all group backdrop-blur-sm">
              ...
              <Link href="/admin/videos" className="p-6 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 hover:border-white/20 transition-all group backdrop-blur-sm">
