...
export const metadata = {
  title: 'Faculty Directory | S.K. Degree & P.G. College',
  description: 'Meet the experienced educators and researchers shaping the next generation at S.K. Degree & P.G. College.',
};
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="sticky top-32 space-y-8">
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                ...
                <nav className="space-y-2">
                  {['All Departments', 'Science', 'Commerce', 'Arts', 'Management', 'Physical Education'].map((dept, i) => (
                    <button 
                      key={i}
                      className={`w-full text-left px-4 py-2 rounded-lg text-sm font-medium transition-all ${i === 0 ? 'bg-academic-navy text-white' : 'text-slate-600 hover:bg-slate-50'}`}
                    >
                      {dept}
                    </button>
                  ))}
          ...
          <div className="lg:col-span-9">
             ...
             <div className="mt-16 text-center">
                <button className="px-10 py-4 bg-white border border-slate-200 text-academic-navy font-bold rounded-xl shadow-sm hover:shadow-md hover:border-academic-gold transition-all duration-300">
                  View Full Directory
                </button>
             </div>
          </div>
