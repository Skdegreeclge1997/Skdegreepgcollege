    ...
    <main className="min-h-screen bg-slate-50 pb-20">
              ...
              <MotionSection delay={0.6} direction="right">
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-3xl relative overflow-hidden group">
                   <div className="relative z-10">
                      <h3 className="text-xl font-bold text-academic-gold mb-4">Why Choose S.K. College?</h3>
      ...
      <section className="container mx-auto px-4 -mt-16 relative z-20">
         <div className="mb-12">
            ...
            <p className="text-slate-500 font-medium">Explore our wide range of professional undergraduate programs.</p>
         </div>
            ...
            {departments.map((dept, deptIdx) => (
               <MotionSection key={dept} delay={deptIdx * 0.1}>
                  <div className="border-b border-slate-200 pb-4 mb-8 flex items-center justify-between">
                     ...
                     <span className="text-xs font-black uppercase tracking-widest text-slate-300">{groupedCourses[dept].length} Programs</span>
                  </div>
                     ...
                     {groupedCourses[dept].map((course, courseIdx) => (
                        ...
                        >
                           <Link href={`/academics/${course.slug}`}>
                              <div className="text-academic-gold font-black text-[10px] uppercase tracking-tighter mb-2">{course.degree}</div>
      ...
      {/* NCC & NSS Section */}
      <section className="bg-white py-24 mt-20 border-y border-slate-100 relative overflow-hidden">
         <div className="container mx-auto px-4 relative z-10">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                     {[
                        ...
                        <div key={i} className="p-4 rounded-2xl bg-slate-50 border border-slate-100">
                           <h4 className="font-bold text-academic-navy mb-1 flex items-center gap-2">
                  ...
                  <div className="relative">
                     <div className="aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl relative">
                        <img 
                           ...
                           alt="Students Discipline" 
                           onError={(e) => {
                              // Fallback if image doesn't exist yet
                              (e.target as HTMLImageElement).src = "https://images.unsplash.com/photo-1541339907198-e08759dfc3ef?auto=format&fit=crop&q=80";
                           }}
